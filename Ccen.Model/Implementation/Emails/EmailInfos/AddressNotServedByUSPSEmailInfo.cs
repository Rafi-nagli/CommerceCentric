...
{
    public class AddressNotServedByUSPSEmailInfo : BaseEmailInfo, IEmailInfo
    {
        public override EmailTypes EmailType
        {
            get { return EmailTypes.AddressNotServedByUSPS; }
        }
        ...
        public string Body
        {
            get { return string.Format(@"<div style=""font-size: 11pt; font-family: Calibri"">
                                 <p>Dear {0},</p>
                                 <p>Postal Service (USPS) reported that they can’t deliver your order to the address you have provided:</p>
                                 <p>{1}</p>
                                 <p>Do you have an alternative address where we can send your order?<br/>
                                    We would appreciate if you reply to this email before {2} with a corrected address or confirm it’s ok to send as-is.<br/>
                                    Please note: At this point we can NOT ship orders using Fedex or UPS.</p>
                                 <br/>
        ...
        public AddressNotServedByUSPSEmailInfo(IAddressService addressService, 
            string byName,
            string orderNumber, 
            MarketType market,
            AddressDTO address,
