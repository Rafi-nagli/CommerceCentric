...
{
    public class ExcelWFSProductUSViewModel : IExcelProductViewModel
    {
        public static string USTemplatePath = "~/App_Data/Flat.File.WFS_Clothing-full.OneSheet.US.xls";
        ...
        [ExcelSerializable("Product Description", Order = 65, Width = 75)]
        public string Description { get; set; }//U can put same as parent’s description for all elements

        [ExcelSerializable("Item Type Keyword", Order = 6, Width = 25)] //recommended_browse_nodes
        ...
        [ExcelSerializable("Update", Order = 64, Width = 25)]
        public string Update { get; set; }//Hardcode to word “update”


        //PART II
        [ExcelSerializable("Standard Price", Order = 48, Width = 25)]
        public string StandardPrice { get; set; }

        [ExcelSerializable("Suggested Price", Order = 222, Width = 25)]
        ...
        [ExcelSerializable("Quantity", Order = 49, Width = 25)]
        ...
        //GREEN
        [ExcelSerializable("KeyProductFeatures1", Order = 74, Width = 25)]
        public string KeyProductFeatures1 { get; set; }

        [ExcelSerializable("KeyProductFeatures2", Order = 75, Width = 25)]
        public string KeyProductFeatures2 { get; set; }

        [ExcelSerializable("KeyProductFeatures3", Order = 76, Width = 25)]
        public string KeyProductFeatures3 { get; set; }

        [ExcelSerializable("KeyProductFeatures4", Order = 77, Width = 25)]
        public string KeyProductFeatures4 { get; set; }

        [ExcelSerializable("KeyProductFeatures5", Order = 78, Width = 25)]
        public string KeyProductFeatures5 { get; set; }

        [ExcelSerializable("SearchTerms", Order = 79, Width = 25)]
        ...
        [ExcelSerializable("Main Image URL", Order = 50, Width = 57)]
        public string MainImageURL { get; set; }
        [ExcelSerializable("OtherImageUrl1", Order = 51, Width = 25)]
        public string OtherImageUrl1 { get; set; }

        [ExcelSerializable("OtherImageUrl2", Order = 52, Width = 25)]
        public string OtherImageUrl2 { get; set; }

        [ExcelSerializable("OtherImageUrl3", Order = 53, Width = 25)]
        public string OtherImageUrl3 { get; set; }

        [ExcelSerializable("SwatchImageUrl", Order = 59, Width = 25)]
        public string SwatchImageUrl { get; set; }

        //PINK
        [ExcelSerializable("Parentage", Order = 60, Width = 25)]
        public string Parentage { get; set; } //Hardcode to 4th row – “parent”, all other rows “Child” 

        [ExcelSerializable("Parent SKU", Order = 61, Width = 35)]
        public string ParentSKU { get; set; } //BS4 –empty, others copy A4 

        [ExcelSerializable("Relationship Type", Order = 62, Width = 25)]
        public string RelationshipType { get; set; } //“Variation”, BT4 – empty

        [ExcelSerializable("Variation Theme", Order = 63, Width = 25)]
        public string VariationTheme { get; set; } //Hardcode to “Size”


        //BROWN

        [ExcelSerializable("Color", Order = 28, Width = 25)]
        public string Color { get; set; } //Can be different for child elements

        [ExcelSerializable("Department", Order = 30, Width = 25)]
        public string Department { get; set; } //Usually: girls, boys, baby-boys, baby-girls

        [ExcelSerializable("Size", Order = 39, Width = 25)]
        ...
        [ExcelSerializable("fulfillment_center_id", Order = 174, Width = 25)]
        public string FulfillmentCenterID { get; set; }

        [ExcelSerializable("package_height", Order = 175, Width = 25)]
        public string PackageHeight { get; set; }

        [ExcelSerializable("package_width", Order = 176, Width = 25)]
        public string PackageWidth { get; set; }

        [ExcelSerializable("package_length", Order = 177, Width = 25)]
        public string PackageLength { get; set; }

        [ExcelSerializable("package_length_unit_of_measure", Order = 180, Width = 25)]
        public string PackageLengthUnitOfMeasure { get; set; }

        [ExcelSerializable("package_weight", Order = 178, Width = 25)]
        public string PackageWeight { get; set; }
        [ExcelSerializable("package_weight_unit_of_measure", Order = 179, Width = 25)]
        public string PackageWeightUnitOfMeasure { get; set; }

        [ExcelSerializable("supplier_declared_dg_hz_regulation1", Order = 204, Width = 25)]
        public string SupplierDeclaredDgHzRegulation1 { get; set; }

        [ExcelSerializable("batteries_required", Order = 186, Width = 25)]
        ...
        [ExcelSerializable("merchant_shipping_group_name", Order = 240)]
