    ...
    var ExtLayoutSplitter = kendo.ui.Splitter.extend({
        ...
        updateCollapsedPanes: function (e) {
            ...
            $.each(panes, function (idx, pane) {
                ...
                if (title && (typeof e == 'undefined' || title.element[0] != e.target)) {
    ...
    kendo.ui.ExtAlertDialog = {
        show: function (options) {
            return new $.Deferred(function (deferred) {
                ...
                $(document.body).append(kendo.format("<div id='extAlertDialog' style='position:relative;'><div style='position:absolute;left:10px;top:10px;' class='{0}'></div><div style='display:inline-block;margin-left:80px;'>{1}</div></div>", options.icon, options.message));
    ...
    kendo.ui.ExtOkCancelDialog = {
        show: function (options) {
            return new $.Deferred(function (deferred) {
                ...
                $(document.body).append(kendo.format("<div id='extOkCancelDialog' style='position:relative;'><div style='position:absolute;left:10px;top:10px;' class='{0}'></div><div style='display:inline-block;margin-left:80px;'>{1}</div></div>", options.icon, options.message));
    ...
    kendo.ui.ExtYesNoDialog = {
        show: function (options) {
            return new $.Deferred(function (deferred) {
                ...
                //$(document.body).append(kendo.format("<div id='extYesNoDialog' style='position:relative;'><div style='position:absolute;left:10px;top:10px;' class='{0}'></div><div style='display:inline-block;margin-left:80px;'>{1}</div></div>", options.icon, options.message));
                $(document.body).append(kendo.format("<div id='extYesNoDialog' style='text-align:center'><div class='{0}'></div><div>{1}</div></div>", options.icon, options.message));
