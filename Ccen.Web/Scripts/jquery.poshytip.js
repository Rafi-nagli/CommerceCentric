...
(function($) {
	...
	$.fn.poshytip.defaults = {
		...
		alignX:			'inner-right',	// horizontal alignment for the tip relative to the mouse cursor or the target element
							// ('right', 'center', 'left', 'inner-left', 'inner-right') - 'inner-*' matter if alignTo:'target'
		alignY: 'inner-top',		// vertical alignment for the tip relative to the mouse cursor or the target element
