...
namespace Amazon.Web.Controllers
{
    public partial class PurchaseOrderController
    {
        ...
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public virtual System.Web.Mvc.ActionResult GetPurchaseOrder()
        {
            return new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.GetPurchaseOrder);
        }
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public PurchaseOrderController Actions { get { return MVC.PurchaseOrder; } }
        ...
        public class ActionNamesClass
        {
            ...
            public readonly string GetPurchaseOrder = "GetPurchaseOrder";
        ...
        public class ActionNameConstants
        {
            ...
            public const string GetPurchaseOrder = "GetPurchaseOrder";
        ...
        static readonly ActionParamsClass_GetPurchaseOrder s_params_GetPurchaseOrder = new ActionParamsClass_GetPurchaseOrder();
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ActionParamsClass_GetPurchaseOrder GetPurchaseOrderParams { get { return s_params_GetPurchaseOrder; } }
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public class ActionParamsClass_GetPurchaseOrder
        {
            public readonly string id = "id";
        }
        ...
        public class ViewsClass
        {
            ...
            {
                public readonly string _EditPurchaseOrder = "_EditPurchaseOrder";
                public readonly string Index = "Index";
            }
            public readonly string _EditPurchaseOrder = "~/Views/PurchaseOrder/_EditPurchaseOrder.cshtml";
            public readonly string Index = "~/Views/PurchaseOrder/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_PurchaseOrderController : Amazon.Web.Controllers.PurchaseOrderController
    {
        ...
        [NonAction]
        partial void OnCreateItemOverride(T4MVC_System_Web_Mvc_ActionResult callInfo);

        [NonAction]
        public override System.Web.Mvc.ActionResult OnCreateItem()
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.OnCreateItem);
            OnCreateItemOverride(callInfo);
            return callInfo;
        }
        ...
        [NonAction]
        partial void SubmitOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Amazon.Web.ViewModels.PurchaseOrders.PurchaseOrderViewModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Submit(Amazon.Web.ViewModels.PurchaseOrders.PurchaseOrderViewModel model)
        {
        ...
        [NonAction]
        partial void GetPurchaseOrderOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, long id);

        [NonAction]
        public override System.Web.Mvc.ActionResult GetPurchaseOrder(long id)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.GetPurchaseOrder);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "id", id);
            GetPurchaseOrderOverride(callInfo, id);
            return callInfo;
        }
