...
{
    public partial class ChildItemController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ChildItemController() { }

        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected ChildItemController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ChildItemController Actions { get { return MVC.ChildItem; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "ChildItem";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "ChildItem";
        ...
        {
            public readonly string requst = "requst";
        ...
        public class ViewsClass
        {
            ...
            {
                public readonly string ItemViewModel = "ItemViewModel";
            }
            public readonly string ItemViewModel = "~/Views/ChildItem/ItemViewModel.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ChildItemController : Amazon.Web.Controllers.ChildItemController
    {
        public T4MVC_ChildItemController() : base(Dummy.Instance) { }
        ...
        [NonAction]
        partial void OnUpdateItemOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, int id, string sku);

        [NonAction]
        public override System.Web.Mvc.ActionResult OnUpdateItem(int id, string sku)
        {
            ...
            OnUpdateItemOverride(callInfo, id, sku);
            return callInfo;
        }

        [NonAction]
        partial void SubmitOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Amazon.Web.ViewModels.Products.EditItemsViewModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Submit(Amazon.Web.ViewModels.Products.EditItemsViewModel model)
        {
