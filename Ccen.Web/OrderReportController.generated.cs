...
{
    public partial class OrderReportController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public OrderReportController() { }

        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected OrderReportController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public OrderReportController Actions { get { return MVC.OrderReport; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "OrderReport";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "OrderReport";
        ...
        public class ViewsClass
        {
            ...
            public readonly string Index = "~/Views/OrderReport/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_OrderReportController : Amazon.Web.Controllers.OrderReportController
    {
        public T4MVC_OrderReportController() : base(Dummy.Instance) { }
        ...
        [NonAction]
        partial void ExportToExcelOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, long? dropShipperId, string orderString, string orderStatus, int? market, System.DateTime? fromDate, System.DateTime? toDate);

        [NonAction]
        public override System.Web.Mvc.ActionResult ExportToExcel(long? dropShipperId, string orderString, string orderStatus, int? market, System.DateTime? fromDate, System.DateTime? toDate)
        {
            ...
            ExportToExcelOverride(callInfo, dropShipperId, orderString, orderStatus, market, fromDate, toDate);
            return callInfo;
        }

        [NonAction]
        partial void GetAllOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Amazon.Web.ViewModels.Grid.GridRequest request, long? dropShipperId, string orderString, string orderStatus, int? market, System.DateTime? fromDate, System.DateTime? toDate);

        [NonAction]
        public override System.Web.Mvc.ActionResult GetAll(Amazon.Web.ViewModels.Grid.GridRequest request, long? dropShipperId, string orderString, string orderStatus, int? market, System.DateTime? fromDate, System.DateTime? toDate)
        {
            ...
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "fromDate", fromDate);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "toDate", toDate);
            GetAllOverride(callInfo, request, dropShipperId, orderString, orderStatus, market, fromDate, toDate);
            return callInfo;
        }
