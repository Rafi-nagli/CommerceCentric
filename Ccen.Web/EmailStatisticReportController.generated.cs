...
{
    public partial class EmailStatisticReportController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public EmailStatisticReportController() { }

        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected EmailStatisticReportController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public EmailStatisticReportController Actions { get { return MVC.EmailStatisticReport; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "EmailStatisticReport";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "EmailStatisticReport";
        ...
        public class ViewsClass
        {
            ...
            public readonly string Index = "~/Views/EmailStatisticReport/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_EmailStatisticReportController : Amazon.Web.Controllers.EmailStatisticReportController
    {
        public T4MVC_EmailStatisticReportController() : base(Dummy.Instance) { }
