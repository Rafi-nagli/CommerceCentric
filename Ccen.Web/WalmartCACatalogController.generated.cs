...
{
    public partial class WalmartCACatalogController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public WalmartCACatalogController() { }

        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected WalmartCACatalogController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public WalmartCACatalogController Actions { get { return MVC.WalmartCACatalog; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "WalmartCACatalog";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "WalmartCACatalog";
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_WalmartCACatalogController : Amazon.Web.Controllers.WalmartCACatalogController
    {
        public T4MVC_WalmartCACatalogController() : base(Dummy.Instance) { }
        ...
        [NonAction]
        partial void SubmitOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Amazon.Web.ViewModels.Walmart.WalmartCACatalogFeedViewModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Submit(Amazon.Web.ViewModels.Walmart.WalmartCACatalogFeedViewModel model)
        {
