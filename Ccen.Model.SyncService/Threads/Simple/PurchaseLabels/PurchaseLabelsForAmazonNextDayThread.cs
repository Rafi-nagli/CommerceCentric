...
{
    public class PurchaseLabelsForAmazonNextDayThread : ThreadBase
    {
        public PurchaseLabelsForAmazonNextDayThread(long companyId, ISystemMessageService messageService, TimeSpan? callbackInterval = null)
            : base("PurchaseLabelsForAmazonNextDay", companyId, messageService, callbackInterval)
        {
